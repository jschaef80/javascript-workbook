...
// function that searches for and filters out even numbers
const evenCheck = nums.filter(num => num % 2 === 0)
// function that takes evenCheck and adds numbers together
const sumEvens = evenCheck.reduce((accumulator, currentValue) => accumulator + currentValue);
...
const weatherStates = weather.map(e => {return e.weather_state_name}).filter( (element, index, array) => {return array.indexOf(element) == index});
console.log(weatherStates);

//find the id of the object in weather that has a min_temp of 15.915

const idealTemp = weather.find(e => e.min_temp === 15.915).id
